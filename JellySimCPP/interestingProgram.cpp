...
void showStatus(std::string yourJellyName, int* ptrHappiness, int* ptrHunger, bool* ptrPooped, bool* ptrSafe);
...
{ //starting operator
    ...
    showStatus(yourJellyName, ptrHappiness, ptrHunger, ptrPooped, ptrSafe);
...
void showStatus(std::string yourJellyName, int* ptrHappiness, int* ptrHunger, bool* ptrPooped, bool* ptrSafe)
{
    std::cout << "Happiness: "<< *ptrHappiness<< ", Hunger: " << *ptrHunger<< ", Clean: " << (*ptrPooped ? "No" : "Yes") << ", Safe: " << (*ptrSafe ? "Yes" : "No") << std::endl;
}
